...
public class MetaAttributeDefinition extends AttributeDefinition {
	...
	public String toString() {
		return "MetaAttributeDefinition [ownerAttributeDefinitionNr="
				+ (ownerAttributeDefinitions == null ? "N/A"
						: ownerAttributeDefinitions.size()) + ", id=" + id
				+ ", name=" + name + ", type=" + type + ", valueRepoType="
				+ valueRepoType + ", multiValue=" + multiValue + ", mandatory="
				+ mandatory + ", metaAttributeDefinitions="
