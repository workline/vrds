...
public enum EAttributeType {
    STRING(StringAttributeValueHandler.getInstance()), INTEGER(IntegerAttributeValueHandler.getInstance()), DECIMAL(null), DATE(null), TIME(null), DATETIME(
            null), REPO_ITEM(RepoItemAttributeValueHandler.getInstance()), ATTRIBUTE(AttributeAttributeValueHandler.getInstance());
